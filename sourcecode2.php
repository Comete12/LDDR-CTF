...
<body>
        ...
        <div class="nav-points">
            <?php
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    $_SESSION['redirection']= 'sourcecode2.php';
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if ($stmt->rowCount() == 0) {
            $sql = "UPDATE users SET points = points + 10 WHERE email = :email";
    ...
    ?>
    <h2 class="title">Level 2 - Source code</h2>
    <p class="title">Sorry, our website is closed for now.</p>
    <form method="POST">
        <label for="submit">Welcome back admin !</label>
        <br>
        <input disabled="true" type="submit" value="Log in" name="submit">
    </form>
    <div class="doc">
        <p>Download the documentation here : </p><button onclick="window.open('documentation_2.pdf')"><img src="download.png" width="30px"></button>
    </div>
    <script>
