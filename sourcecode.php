...
<body>
        ...
        <div class="nav-points">
            <?php
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    $_SESSION['redirection']= 'sourcecode.php';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($password != "") {
            $req = $conn->prepare("SELECT * FROM sqlinjection WHERE username = 'sourcecode' AND password = :password");
    ...
    <h2 class="title">Level 1 - Source code</h2>
    <p class="title">Find the password !</p>
    <form method="POST">
    ...
    ?>
    <div class="doc">
        <p>Download the documentation here : </p><button onclick="window.open('documentation_1.pdf')"><img src="download.png" width="30px"></button>
    </div>
