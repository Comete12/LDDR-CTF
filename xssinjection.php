...
<body>
        ...
        <div class="nav-points">
            <?php
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    $_SESSION['redirection']= 'xssinjection.php';
    ...
    $dbname ="DB9db62";
    $error_msg="";
    setcookie('PASSWORD', 'Ovfs2n97u64Z');
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($password && $username != "") {
            $req = $conn->prepare("SELECT * FROM xssinjection WHERE username = :username AND password = :password");
            ...
            if ($rep) {
                ...
                $error_msg = "<p>Sorry {$username}, username or password incorrect !</p>";
            } 
    ...
    ?>
    <h2 class="title">Level 7 - XSS Injection</h2>
