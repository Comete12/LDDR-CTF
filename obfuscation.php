...
<head>
    ...
    <title>LDDR-CTF - Obfuscation</title>
...
<div class="off-screen-menu">
            ...
            <div class="nav-points">
                <?php
                    ...
                    if(isset($_SESSION['username'])) {
                        ...
                        $_SESSION['redirection']= 'obfuscation.php';
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($password != ""){
            $req = $conn->prepare("SELECT * FROM sqlinjection WHERE username = 'obfuscation' AND password = :password");
    ...
    ?>
    <h2 class="title">Level 3 - Obfuscation</h2>
    ...
    ?>
    <div class="doc">
        <p>Download the documentation here : </p><button onclick="window.open('documentation_3.pdf')"><img src="download.png" width="30px"></button>
    </div>
