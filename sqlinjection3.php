...
<div class="off-screen-menu">
            ...
            <div class="nav-points">
                <?php
                    ...
                    if(isset($_SESSION['username'])) {
                        ...
                        $_SESSION['redirection']= 'sqlinjection3.php';
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($password != ""){
            $req = $conn->prepare("SELECT * FROM admintable WHERE username = :username AND password = :password");
            $req->execute(['username' => 'admin', 'password' => $password]);
            $rep = $req->fetch();
            ...
            if ($rep) {
                ...
                if ($stmt->rowCount() == 0) {
                    $sql = "UPDATE users SET points = points + 20 WHERE email = :email";
    ...
    ?>
    <h2 class="title">Level 6 - SQL Injection</h2>
    ...
    ?>
    <h3 class="title">Nothing to see here...</h3>
    <!-- The password is stored in admintable -->
    <h4 class="title">Perhaps you could take a look at the <a href="index.php">leaderboard</a> ?</h4>
    <div class="doc">
        <p>Download the documentation here : </p><button onclick="window.open('documentation_6.pdf')"><img src="download.png" width="30px"></button>
    </div>
    <script>
