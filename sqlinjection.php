...
<div class="off-screen-menu">
            ...
            <div class="nav-points">
                <?php
                    ...
                    if(isset($_SESSION['username'])) {
                        ...
                        $_SESSION['redirection']= 'sqlinjection.php';
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($username != "" && $password != ""){
            $req = $conn->query("SELECT * FROM sqlinjection WHERE username ='$username' AND password='$password'");
            $rep = $req->fetch();
            if($rep){
                $level = 4;
    ...
    ?>
    <h2 class="title">Level 4 - SQL Injection</h2>
    ...
    <div class="doc">
        <p>Download the documentation here : </p><button onclick="window.open('documentation_4.pdf')"><img src="download.png" width="30px"></button>
    </div>
    <script>
